package ua.social.network.authservice.config;
...
import ua.social.network.authservice.oauth2.SnTokenEnhancer;
import ua.social.network.authservice.service.SnUserDetailsService;
